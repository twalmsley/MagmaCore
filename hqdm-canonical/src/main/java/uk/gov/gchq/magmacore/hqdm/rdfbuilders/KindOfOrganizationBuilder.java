...
public class KindOfOrganizationBuilder {
    ...
    /**
     * An inverse {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF_BY_CLASS} relationship
     ...
     * @return This builder.
     */
    public final KindOfOrganizationBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.kindOfOrganization.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final KindOfOrganizationBuilder member_Of(final Class clazz) {
        this.kindOfOrganization.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final KindOfOrganizationBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.kindOfOrganization.addValue(MEMBER_OF,
     ...
     * @return This builder.
     */
    public final KindOfOrganizationBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.kindOfOrganization.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public KindOfOrganization build() throws HqdmException {
        ...
        if (this.kindOfOrganization.hasValue(PART_OF_BY_CLASS)
                && this.kindOfOrganization.values(PART_OF_BY_CLASS).isEmpty()) {
