...
public class StateOfSignBuilder {
     ...
     * @return This builder.
     */
    public final StateOfSignBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSign.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSignBuilder member_Of(final Class clazz) {
        this.stateOfSign.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSignBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSign.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSignBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSign.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public StateOfSign build() throws HqdmException {
        ...
        if (this.stateOfSign.hasValue(PART_OF)
                && this.stateOfSign.values(PART_OF).isEmpty()) {
