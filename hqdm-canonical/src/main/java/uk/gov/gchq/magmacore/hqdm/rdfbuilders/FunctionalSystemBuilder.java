...
public class FunctionalSystemBuilder {
     ...
     * @return This builder.
     */
    public final FunctionalSystemBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.functionalSystem.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final FunctionalSystemBuilder member_Of(final Class clazz) {
        this.functionalSystem.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final FunctionalSystemBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.functionalSystem.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final FunctionalSystemBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.functionalSystem.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public FunctionalSystem build() throws HqdmException {
        ...
        if (this.functionalSystem.hasValue(PART_OF)
                && this.functionalSystem.values(PART_OF).isEmpty()) {
