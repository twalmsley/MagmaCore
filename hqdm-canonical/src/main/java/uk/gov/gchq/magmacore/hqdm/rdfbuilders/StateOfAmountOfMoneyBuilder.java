...
public class StateOfAmountOfMoneyBuilder {
     ...
     * @return This builder.
     */
    public final StateOfAmountOfMoneyBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfAmountOfMoney.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfAmountOfMoneyBuilder member_Of(final Class clazz) {
        this.stateOfAmountOfMoney.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfAmountOfMoneyBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfAmountOfMoney.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfAmountOfMoneyBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfAmountOfMoney.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public StateOfAmountOfMoney build() throws HqdmException {
        ...
        if (this.stateOfAmountOfMoney.hasValue(PART_OF)
                && this.stateOfAmountOfMoney.values(PART_OF).isEmpty()) {
