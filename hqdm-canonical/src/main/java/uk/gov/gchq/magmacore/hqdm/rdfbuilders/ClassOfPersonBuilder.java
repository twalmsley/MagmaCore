...
public class ClassOfPersonBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfPersonBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfPerson.addValue(CONSISTS_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfPersonBuilder member_Of(final Class clazz) {
        this.classOfPerson.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfPersonBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfPerson.addValue(MEMBER_OF, classOfClassOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfPersonBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfPerson.addValue(PART_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfPerson build() throws HqdmException {
        ...
        if (this.classOfPerson.hasValue(PART_OF_BY_CLASS)
                && this.classOfPerson.values(PART_OF_BY_CLASS).isEmpty()) {
