...
public class StateOfPartyBuilder {
     ...
     * @return This builder.
     */
    public final StateOfPartyBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfParty.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfPartyBuilder member_Of(final Class clazz) {
        this.stateOfParty.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfPartyBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfParty.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfPartyBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfParty.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public StateOfParty build() throws HqdmException {
        ...
        if (this.stateOfParty.hasValue(PART_OF)
                && this.stateOfParty.values(PART_OF).isEmpty()) {
