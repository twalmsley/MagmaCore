...
public class StateOfBiologicalObjectBuilder {
     ...
     * @return This builder.
     */
    public final StateOfBiologicalObjectBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfBiologicalObject.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfBiologicalObjectBuilder member_Of(final Class clazz) {
        this.stateOfBiologicalObject.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfBiologicalObjectBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfBiologicalObject.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfBiologicalObjectBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfBiologicalObject.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public StateOfBiologicalObject build() throws HqdmException {
        ...
        if (this.stateOfBiologicalObject.hasValue(PART_OF)
                && this.stateOfBiologicalObject.values(PART_OF).isEmpty()) {
