...
public class ClassOfStateOfPartyBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfStateOfPartyBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfStateOfParty.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfStateOfPartyBuilder member_Of(final Class clazz) {
        this.classOfStateOfParty.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfStateOfPartyBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfStateOfParty.addValue(MEMBER_OF,
     ...
     * @return This builder.
     */
    public final ClassOfStateOfPartyBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfStateOfParty.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfStateOfParty build() throws HqdmException {
        ...
        if (this.classOfStateOfParty.hasValue(PART_OF_BY_CLASS)
                && this.classOfStateOfParty.values(PART_OF_BY_CLASS).isEmpty()) {
