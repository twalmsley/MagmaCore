...
public class PriceBuilder {
     ...
     * @return This builder.
     */
    public final PriceBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.price.addValue(CONSISTS_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final PriceBuilder member_Of(final Class clazz) {
        this.price.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final PriceBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.price.addValue(MEMBER_OF, classOfClassOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final PriceBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.price.addValue(PART_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public Price build() throws HqdmException {
        ...
        if (this.price.hasValue(PART_OF_BY_CLASS)
                && this.price.values(PART_OF_BY_CLASS).isEmpty()) {
