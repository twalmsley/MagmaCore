...
public class ClassOfSignBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfSignBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfSign.addValue(CONSISTS_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfSignBuilder member_Of(final Class clazz) {
        this.classOfSign.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfSignBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfSign.addValue(MEMBER_OF, classOfClassOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfSignBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfSign.addValue(PART_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfSign build() throws HqdmException {
        ...
        if (this.classOfSign.hasValue(PART_OF_BY_CLASS)
                && this.classOfSign.values(PART_OF_BY_CLASS).isEmpty()) {
