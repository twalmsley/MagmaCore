...
public class ClassOfFunctionalSystemComponentBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfFunctionalSystemComponentBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfFunctionalSystemComponent.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfFunctionalSystemComponentBuilder member_Of(final Class clazz) {
        this.classOfFunctionalSystemComponent.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfFunctionalSystemComponentBuilder member_Of(
     ...
     * @return This builder.
     */
    public final ClassOfFunctionalSystemComponentBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfFunctionalSystemComponent.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfFunctionalSystemComponent build() throws HqdmException {
        ...
        if (this.classOfFunctionalSystemComponent.hasValue(PART_OF_BY_CLASS)
                && this.classOfFunctionalSystemComponent.values(PART_OF_BY_CLASS).isEmpty()) {
