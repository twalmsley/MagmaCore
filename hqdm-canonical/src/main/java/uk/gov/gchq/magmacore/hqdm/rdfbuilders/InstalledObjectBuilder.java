...
public class InstalledObjectBuilder {
     ...
     * @return This builder.
     */
    public final InstalledObjectBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.installedObject.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final InstalledObjectBuilder member_Of(final Class clazz) {
        this.installedObject.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final InstalledObjectBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.installedObject.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final InstalledObjectBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.installedObject.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
