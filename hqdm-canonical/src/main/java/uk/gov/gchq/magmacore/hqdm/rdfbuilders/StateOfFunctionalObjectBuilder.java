...
public class StateOfFunctionalObjectBuilder {
     ...
     * @return This builder.
     */
    public final StateOfFunctionalObjectBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfFunctionalObject.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfFunctionalObjectBuilder member_Of(final Class clazz) {
        this.stateOfFunctionalObject.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfFunctionalObjectBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfFunctionalObject.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfFunctionalObjectBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfFunctionalObject.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
