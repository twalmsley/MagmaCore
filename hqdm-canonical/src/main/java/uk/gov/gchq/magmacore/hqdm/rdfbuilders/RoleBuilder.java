...
public class RoleBuilder {
     ...
     * @return This builder.
     */
    public final RoleBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.role.addValue(CONSISTS_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final RoleBuilder member_Of(final Class clazz) {
        this.role.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final RoleBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.role.addValue(MEMBER_OF, classOfClassOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final RoleBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.role.addValue(PART_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final RoleBuilder part_Of_By_Class(final KindOfAssociation kindOfAssociation) {
        this.role.addValue(PART_OF_BY_CLASS, kindOfAssociation.getId());
        return this;
    }
