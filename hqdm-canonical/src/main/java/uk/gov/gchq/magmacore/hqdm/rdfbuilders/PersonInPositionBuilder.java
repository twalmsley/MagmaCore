...
public class PersonInPositionBuilder {
     ...
     * @return This builder.
     */
    public final PersonInPositionBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.personInPosition.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final PersonInPositionBuilder member_Of(final Class clazz) {
        this.personInPosition.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final PersonInPositionBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.personInPosition.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final PersonInPositionBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.personInPosition.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public PersonInPosition build() throws HqdmException {
        ...
        if (this.personInPosition.hasValue(PART_OF)
                && this.personInPosition.values(PART_OF).isEmpty()) {
