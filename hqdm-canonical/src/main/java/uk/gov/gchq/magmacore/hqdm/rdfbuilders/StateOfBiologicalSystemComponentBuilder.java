...
public class StateOfBiologicalSystemComponentBuilder {
     ...
     * @return This builder.
     */
    public final StateOfBiologicalSystemComponentBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfBiologicalSystemComponent.addValue(CONSISTS_OF,
                spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfBiologicalSystemComponentBuilder member_Of(final Class clazz) {
        this.stateOfBiologicalSystemComponent.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfBiologicalSystemComponentBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfBiologicalSystemComponent.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public StateOfBiologicalSystemComponent build() throws HqdmException {
        ...
        if (this.stateOfBiologicalSystemComponent.hasValue(PART_OF)
                && this.stateOfBiologicalSystemComponent.values(PART_OF).isEmpty()) {
