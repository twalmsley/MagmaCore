...
public class BeginningOfOwnershipBuilder {
     ...
     * @return This builder.
     */
    public final BeginningOfOwnershipBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.beginningOfOwnership.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final BeginningOfOwnershipBuilder member_Of(final Class clazz) {
        this.beginningOfOwnership.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final BeginningOfOwnershipBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.beginningOfOwnership.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final BeginningOfOwnershipBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.beginningOfOwnership.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public BeginningOfOwnership build() throws HqdmException {
        ...
        if (this.beginningOfOwnership.hasValue(TEMPORAL_PART_OF)
                && this.beginningOfOwnership.values(TEMPORAL_PART_OF).isEmpty()) {
