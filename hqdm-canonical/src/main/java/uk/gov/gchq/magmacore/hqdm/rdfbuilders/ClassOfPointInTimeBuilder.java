...
public class ClassOfPointInTimeBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfPointInTimeBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfPointInTime.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfPointInTimeBuilder member_Of(final Class clazz) {
        this.classOfPointInTime.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfPointInTimeBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfPointInTime.addValue(MEMBER_OF,
    ...
    public final ClassOfPointInTimeBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfPointInTime.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfPointInTime build() throws HqdmException {
        ...
        if (this.classOfPointInTime.hasValue(PART_OF_BY_CLASS)
                && this.classOfPointInTime.values(PART_OF_BY_CLASS).isEmpty()) {
