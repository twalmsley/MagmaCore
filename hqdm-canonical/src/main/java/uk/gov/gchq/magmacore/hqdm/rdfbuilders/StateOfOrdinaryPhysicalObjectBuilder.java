...
public class StateOfOrdinaryPhysicalObjectBuilder {
     ...
     * @return This builder.
     */
    public final StateOfOrdinaryPhysicalObjectBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfOrdinaryPhysicalObject.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfOrdinaryPhysicalObjectBuilder member_Of(final Class clazz) {
        this.stateOfOrdinaryPhysicalObject.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfOrdinaryPhysicalObjectBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfOrdinaryPhysicalObject.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
