...
public class ClassOfStateOfSystemComponentBuilder {
    ...
    public final ClassOfStateOfSystemComponentBuilder consists_Of_By_Class(
        ...
        this.classOfStateOfSystemComponent.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfStateOfSystemComponentBuilder member_Of(final Class clazz) {
        this.classOfStateOfSystemComponent.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfStateOfSystemComponentBuilder member_Of(
     ...
     * @return This builder.
     */
    public final ClassOfStateOfSystemComponentBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfStateOfSystemComponent.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
