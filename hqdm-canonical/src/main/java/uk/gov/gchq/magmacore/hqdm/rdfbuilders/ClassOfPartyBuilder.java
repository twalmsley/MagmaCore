...
public class ClassOfPartyBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfPartyBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfParty.addValue(CONSISTS_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfPartyBuilder member_Of(final Class clazz) {
        this.classOfParty.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfPartyBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfParty.addValue(MEMBER_OF, classOfClassOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfPartyBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfParty.addValue(PART_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfParty build() throws HqdmException {
        ...
        if (this.classOfParty.hasValue(PART_OF_BY_CLASS)
                && this.classOfParty.values(PART_OF_BY_CLASS).isEmpty()) {
