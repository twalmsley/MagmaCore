...
public class StateOfBiologicalSystemBuilder {
     ...
     * @return This builder.
     */
    public final StateOfBiologicalSystemBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfBiologicalSystem.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfBiologicalSystemBuilder member_Of(final Class clazz) {
        this.stateOfBiologicalSystem.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfBiologicalSystemBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfBiologicalSystem.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfBiologicalSystemBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfBiologicalSystem.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public StateOfBiologicalSystem build() throws HqdmException {
        ...
        if (this.stateOfBiologicalSystem.hasValue(PART_OF)
                && this.stateOfBiologicalSystem.values(PART_OF).isEmpty()) {
