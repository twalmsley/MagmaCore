...
public class StateOfSystemComponentBuilder {
     ...
     * @return This builder.
     */
    public final StateOfSystemComponentBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSystemComponent.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSystemComponentBuilder member_Of(final Class clazz) {
        this.stateOfSystemComponent.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSystemComponentBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSystemComponent.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSystemComponentBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSystemComponent.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
