...
public class ClassOfBiologicalObjectBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfBiologicalObjectBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfBiologicalObject.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfBiologicalObjectBuilder member_Of(final Class clazz) {
        this.classOfBiologicalObject.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfBiologicalObjectBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfBiologicalObject.addValue(MEMBER_OF,
     ...
     * @return This builder.
     */
    public final ClassOfBiologicalObjectBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfBiologicalObject.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfBiologicalObject build() throws HqdmException {
        ...
        if (this.classOfBiologicalObject.hasValue(PART_OF_BY_CLASS)
                && this.classOfBiologicalObject.values(PART_OF_BY_CLASS).isEmpty()) {
