...
public class ClassOfIndividualBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfIndividualBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfIndividual.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfIndividualBuilder member_Of(final Class clazz) {
        this.classOfIndividual.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfIndividualBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfIndividual.addValue(MEMBER_OF, classOfClassOfSpatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfIndividualBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfIndividual.addValue(PART_OF_BY_CLASS, classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfIndividual build() throws HqdmException {
        ...
        if (this.classOfIndividual.hasValue(PART_OF_BY_CLASS)
                && this.classOfIndividual.values(PART_OF_BY_CLASS).isEmpty()) {
