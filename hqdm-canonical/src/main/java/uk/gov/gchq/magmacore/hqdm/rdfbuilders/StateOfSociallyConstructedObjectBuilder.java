...
public class StateOfSociallyConstructedObjectBuilder {
     ...
     * @return This builder.
     */
    public final StateOfSociallyConstructedObjectBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSociallyConstructedObject.addValue(CONSISTS_OF,
                spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSociallyConstructedObjectBuilder member_Of(final Class clazz) {
        this.stateOfSociallyConstructedObject.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSociallyConstructedObjectBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSociallyConstructedObject.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public StateOfSociallyConstructedObject build() throws HqdmException {
        ...
        if (this.stateOfSociallyConstructedObject.hasValue(PART_OF)
                && this.stateOfSociallyConstructedObject.values(PART_OF).isEmpty()) {
