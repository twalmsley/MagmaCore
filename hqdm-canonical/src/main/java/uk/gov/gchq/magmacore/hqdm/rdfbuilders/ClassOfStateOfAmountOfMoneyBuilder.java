...
public class ClassOfStateOfAmountOfMoneyBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfStateOfAmountOfMoneyBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfStateOfAmountOfMoney.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfStateOfAmountOfMoneyBuilder member_Of(final Class clazz) {
        this.classOfStateOfAmountOfMoney.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfStateOfAmountOfMoneyBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfStateOfAmountOfMoney.addValue(MEMBER_OF,
     ...
     * @return This builder.
     */
    public final ClassOfStateOfAmountOfMoneyBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfStateOfAmountOfMoney.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfStateOfAmountOfMoney build() throws HqdmException {
        ...
        if (this.classOfStateOfAmountOfMoney.hasValue(PART_OF_BY_CLASS)
                && this.classOfStateOfAmountOfMoney.values(PART_OF_BY_CLASS).isEmpty()) {
