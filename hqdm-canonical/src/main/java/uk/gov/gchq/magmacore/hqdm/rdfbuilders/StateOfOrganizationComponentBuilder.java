...
public class StateOfOrganizationComponentBuilder {
     ...
     * @return This builder.
     */
    public final StateOfOrganizationComponentBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfOrganizationComponent.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfOrganizationComponentBuilder member_Of(final Class clazz) {
        this.stateOfOrganizationComponent.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfOrganizationComponentBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfOrganizationComponent.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public StateOfOrganizationComponent build() throws HqdmException {
        ...
        if (this.stateOfOrganizationComponent.hasValue(PART_OF)
                && this.stateOfOrganizationComponent.values(PART_OF).isEmpty()) {
