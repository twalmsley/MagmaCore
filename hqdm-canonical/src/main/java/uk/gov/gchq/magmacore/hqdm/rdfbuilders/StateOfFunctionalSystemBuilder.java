...
public class StateOfFunctionalSystemBuilder {
     ...
     * @return This builder.
     */
    public final StateOfFunctionalSystemBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfFunctionalSystem.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfFunctionalSystemBuilder member_Of(final Class clazz) {
        this.stateOfFunctionalSystem.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfFunctionalSystemBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfFunctionalSystem.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfFunctionalSystemBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfFunctionalSystem.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public StateOfFunctionalSystem build() throws HqdmException {
        ...
        if (this.stateOfFunctionalSystem.hasValue(PART_OF)
                && this.stateOfFunctionalSystem.values(PART_OF).isEmpty()) {
