...
public class StateOfOrdinaryFunctionalObjectBuilder {
     ...
     * @return This builder.
     */
    public final StateOfOrdinaryFunctionalObjectBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfOrdinaryFunctionalObject.addValue(CONSISTS_OF,
                spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfOrdinaryFunctionalObjectBuilder member_Of(final Class clazz) {
        this.stateOfOrdinaryFunctionalObject.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfOrdinaryFunctionalObjectBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfOrdinaryFunctionalObject.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
