...
public class RequirementBuilder {
     ...
     * @return This builder.
     */
    public final RequirementBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.requirement.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final RequirementBuilder member_Of(final Class clazz) {
        this.requirement.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final RequirementBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.requirement.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final RequirementBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.requirement.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public Requirement build() throws HqdmException {
        ...
        if (this.requirement.hasValue(TEMPORAL_PART_OF)
                && this.requirement.values(TEMPORAL_PART_OF).isEmpty()) {
