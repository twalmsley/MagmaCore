...
public class AssociationBuilder {
     ...
     * @return This builder.
     */
    public final AssociationBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.association.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final AssociationBuilder member_Of(final Class clazz) {
        this.association.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final AssociationBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.association.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final AssociationBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.association.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public Association build() throws HqdmException {
        ...
        if (this.association.hasValue(PART_OF)
                && this.association.values(PART_OF).isEmpty()) {
