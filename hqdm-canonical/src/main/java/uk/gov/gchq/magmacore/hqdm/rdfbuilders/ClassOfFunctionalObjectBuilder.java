...
public class ClassOfFunctionalObjectBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfFunctionalObjectBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfFunctionalObject.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfFunctionalObjectBuilder member_Of(final Class clazz) {
        this.classOfFunctionalObject.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfFunctionalObjectBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfFunctionalObject.addValue(MEMBER_OF,
     ...
     * @return This builder.
     */
    public final ClassOfFunctionalObjectBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfFunctionalObject.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfFunctionalObject build() throws HqdmException {
        ...
        if (this.classOfFunctionalObject.hasValue(PART_OF_BY_CLASS)
                && this.classOfFunctionalObject.values(PART_OF_BY_CLASS).isEmpty()) {
