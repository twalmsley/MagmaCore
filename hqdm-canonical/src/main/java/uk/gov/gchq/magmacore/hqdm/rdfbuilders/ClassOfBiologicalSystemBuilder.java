...
public class ClassOfBiologicalSystemBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfBiologicalSystemBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfBiologicalSystem.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfBiologicalSystemBuilder member_Of(final Class clazz) {
        this.classOfBiologicalSystem.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfBiologicalSystemBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfBiologicalSystem.addValue(MEMBER_OF,
     ...
     * @return This builder.
     */
    public final ClassOfBiologicalSystemBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfBiologicalSystem.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfBiologicalSystem build() throws HqdmException {
        ...
        if (this.classOfBiologicalSystem.hasValue(PART_OF_BY_CLASS)
                && this.classOfBiologicalSystem.values(PART_OF_BY_CLASS).isEmpty()) {
