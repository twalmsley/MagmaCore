...
public class ClassOfPersonInPositionBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfPersonInPositionBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfPersonInPosition.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfPersonInPositionBuilder member_Of(final Class clazz) {
        this.classOfPersonInPosition.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfPersonInPositionBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfPersonInPosition.addValue(MEMBER_OF,
     ...
     * @return This builder.
     */
    public final ClassOfPersonInPositionBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfPersonInPosition.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
