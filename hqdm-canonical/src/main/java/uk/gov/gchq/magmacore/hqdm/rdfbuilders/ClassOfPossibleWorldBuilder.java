...
public class ClassOfPossibleWorldBuilder {
     ...
     * @return This builder.
     */
    public final ClassOfPossibleWorldBuilder consists_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfPossibleWorld.addValue(CONSISTS_OF_BY_CLASS,
     ...
     * @return This builder.
     */
    public final ClassOfPossibleWorldBuilder member_Of(final Class clazz) {
        this.classOfPossibleWorld.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final ClassOfPossibleWorldBuilder member_Of(
            final ClassOfClassOfSpatioTemporalExtent classOfClassOfSpatioTemporalExtent) {
        this.classOfPossibleWorld.addValue(MEMBER_OF,
     ...
     * @return This builder.
     */
    public final ClassOfPossibleWorldBuilder part_Of_By_Class(
            final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
        this.classOfPossibleWorld.addValue(PART_OF_BY_CLASS,
                classOfSpatioTemporalExtent.getId());
        return this;
    }
    ...
    public ClassOfPossibleWorld build() throws HqdmException {
        ...
        if (this.classOfPossibleWorld.hasValue(PART_OF_BY_CLASS)
                && this.classOfPossibleWorld.values(PART_OF_BY_CLASS).isEmpty()) {
