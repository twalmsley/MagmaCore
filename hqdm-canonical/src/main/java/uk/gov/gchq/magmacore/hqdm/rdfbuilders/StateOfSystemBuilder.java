...
public class StateOfSystemBuilder {
     ...
     * @return This builder.
     */
    public final StateOfSystemBuilder consists_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSystem.addValue(CONSISTS_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSystemBuilder member_Of(final Class clazz) {
        this.stateOfSystem.addValue(MEMBER_OF, clazz.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSystemBuilder part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSystem.addValue(PART_OF, spatioTemporalExtent.getId());
        return this;
    }
     ...
     * @return This builder.
     */
    public final StateOfSystemBuilder temporal_Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
        this.stateOfSystem.addValue(TEMPORAL_PART_OF, spatioTemporalExtent.getId());
        return this;
    }
    ...
    public StateOfSystem build() throws HqdmException {
        ...
        if (this.stateOfSystem.hasValue(PART_OF)
                && this.stateOfSystem.values(PART_OF).isEmpty()) {
